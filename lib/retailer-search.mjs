...
export function normalizeResults(data,request){
 ...
 return {offers,sources:[...sourceUrls].slice(0,10),candidateCount:Array.isArray(json.offers)?json.offers.length:0,checkedAt:new Date().toISOString(),query:request.query,quantity:request.quantity,location:request.location||'Selected location',radius:request.radius,mode:request.mode};
}
