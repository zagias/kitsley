...
export function setupFlow(record){
 ...
 if(/bookcase|bookshelf|book shelf/i.test(record.request))profile={...profile,question:'What will it need to hold?',choices:['Mostly books','Light objects and decor','A mixture','Not sure yet']};
 else if(/cabinet/i.test(record.request)&&/build|make|new/i.test(record.request))profile={...profile,question:'What kind of cabinet do you want?',choices:['Kitchen base cabinet','Wall cabinet','Freestanding storage','Not sure yet']};
