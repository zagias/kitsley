...
export function shelfChange(record,text){
 ...
 const target=/\bC([1-3])\b/i.exec(text),which=target?Number(target[1])-1:/\b(top|upper)\b/i.test(text)?d.shelves-1:/\b(bottom|lower)\b/i.test(text)?0:/\bmiddle\b/i.test(text)&&d.shelves===3?1:d.shelves===1?0:null;
