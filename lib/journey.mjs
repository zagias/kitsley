...
export function safeReturnPath(value){
 ...
 try{const url=new URL(value,'https://kitsley.invalid');return url.origin==='https://kitsley.invalid'&&/^\/(project\/[\w-]+|offers|projects|toolbox|kit|profile|library|guides\/[\w-]+)?$/.test(url.pathname)?url.pathname+url.search:'/';}catch{return '/';}
}
