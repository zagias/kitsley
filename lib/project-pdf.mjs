import {displayLength as length,unitQuantity,measurementText} from './units.mjs';
...
export async function projectPDF(payload){
 ...
 if(payload.input){
  ...
  page(title);para(dims,11,accent);if(units==='imperial')para('~ means an approximate tape fraction, rounded to 1/16 inch. Exact mm sizes are retained for cutting and drilling; rounding individual parts can change the fit.',9);para('Use this revision throughout the build. Check already-cut pieces if your design has changed.',9);
