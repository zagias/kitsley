...
export function knowledgeCoverage(records=[],now=Date.now()){
 ...
 return {version:foundationVersion,kind:'reference-coverage',modelTraining:false,expertCertification:false,
  ...
  publication:'Versioned editorial catalog. User questions identify gaps; AI research remains private and cannot publish rules or train model weights.'};
}
