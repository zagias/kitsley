...
export const safetyVersion='kitsley-safety-2026-09-26.2';
const rules=[
...
export function directSafetyResponse(question,context=''){
 const protective=/\b(?:gfci|gfi|afci|rcd|breaker|interlock|blade guard|safety guard)\b/i.test(question+' '+context);
