...
export const safetyVersion='kitsley-safety-2026-09-26.1';
const rules=[
 ...
 {id:'structure',match:/\b(?:load[- ]bearing|structural|foundation wall|roof truss|support beam)\b/i,title:'Structural work',stop:'Do not remove, cut or alter structural support without a competent site-specific assessment.',need:'A qualified designer’s assessment and local requirements.',jurisdiction:true,professional:true}
];
...
export function directSafetyResponse(question){
