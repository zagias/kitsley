...
export function engineDecision({record={},question='',raw={},result,research}){
 ...
 const proposal=(research.status==='supported'&&raw.designOperation?.factsComplete!==false)||geometryOnly?compileProposal(record,raw.designOperation,question):null;
